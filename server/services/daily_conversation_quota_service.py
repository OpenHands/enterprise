...
class DailyConversationQuotaService:
    ...
    async def get_limit(self, user_id: str, org_id: UUID | None) -> int | None:
        ...
        Without an effective org (``None``) only the user-level override and
        the deployment default apply.
        """
    ...
    async def reserve(self, user_id: str, org_id: UUID | None) -> bool:
