...
import { AuthError, PasswordFields } from "./auth-form";
...
export function PasswordChange(): React.JSX.Element | null {
  ...
  // Wait for the account profile before offering password operations.
  ...
  return (
    <section className="max-w-[680px] flex flex-col gap-4">
      ...
      {complete && <p role="status">{t("AUTH$PASSWORD_CHANGED")}</p>}
