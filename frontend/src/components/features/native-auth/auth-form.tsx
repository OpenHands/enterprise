...
export function PasswordFields(): React.JSX.Element {
  ...
  return (
    <>
      <SettingsInput
        className="w-full"
        label={t("NATIVE_AUTH$NEW_PASSWORD")}
        type="password"
        name="password"
      ...
      <p className="text-sm text-tertiary-alt">
        {t("NATIVE_AUTH$PASSWORD_HELP")}
      </p>
      <SettingsInput
        className="w-full"
        label={t("NATIVE_AUTH$CONFIRM_PASSWORD")}
        type="password"
        name="confirmation"
        autoComplete="new-password"
        minLength={15}
