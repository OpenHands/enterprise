...
export enum I18nKey {
  ...
  SECRETS$SHARE_WITH_ORGANIZATION = "SECRETS$SHARE_WITH_ORGANIZATION",
  SECRETS$SHARE_WITH_ORGANIZATION_DESCRIPTION = "SECRETS$SHARE_WITH_ORGANIZATION_DESCRIPTION",
  SECRETS$ORG_SHARED_BADGE = "SECRETS$ORG_SHARED_BADGE",
  ...
  SETTINGS$PAGE_QUOTA_SUBLINE = "SETTINGS$PAGE_QUOTA_SUBLINE",
  ...
  AZURE_DEVOPS$NO_ORGANIZATIONS = "AZURE_DEVOPS$NO_ORGANIZATIONS",
  ...
  SETTINGS$AGENT_CONTEXT = "SETTINGS$AGENT_CONTEXT",
  SETTINGS$AGENT_CONTEXT_DESCRIPTION = "SETTINGS$AGENT_CONTEXT_DESCRIPTION",
  SETTINGS$ENABLE_MEMORY_CONTEXT = "SETTINGS$ENABLE_MEMORY_CONTEXT",
  SETTINGS$ENABLE_MEMORY_CONTEXT_HELPER = "SETTINGS$ENABLE_MEMORY_CONTEXT_HELPER",
  ...
  SETTINGS$MCP_TEST_CONNECTION = "SETTINGS$MCP_TEST_CONNECTION",
  SETTINGS$MCP_TESTING = "SETTINGS$MCP_TESTING",
  SETTINGS$MCP_TEST_SUCCESS = "SETTINGS$MCP_TEST_SUCCESS",
  SETTINGS$MCP_TEST_ERROR_TIMEOUT = "SETTINGS$MCP_TEST_ERROR_TIMEOUT",
  SETTINGS$MCP_TEST_ERROR_CONNECTION = "SETTINGS$MCP_TEST_ERROR_CONNECTION",
  SETTINGS$MCP_TEST_ERROR_UNKNOWN = "SETTINGS$MCP_TEST_ERROR_UNKNOWN",
  ...
  SETTINGS$NAV_YOUR_BUDGET = "SETTINGS$NAV_YOUR_BUDGET",
  SETTINGS$PAGE_YOUR_BUDGET_SUBLINE = "SETTINGS$PAGE_YOUR_BUDGET_SUBLINE",
  SETTINGS$YOUR_BUDGET_WEEK = "SETTINGS$YOUR_BUDGET_WEEK",
  SETTINGS$YOUR_BUDGET_MONTH = "SETTINGS$YOUR_BUDGET_MONTH",
  SETTINGS$YOUR_BUDGET_YEAR = "SETTINGS$YOUR_BUDGET_YEAR",
  SETTINGS$YOUR_BUDGET_LAST_7_DAYS = "SETTINGS$YOUR_BUDGET_LAST_7_DAYS",
  SETTINGS$YOUR_BUDGET_LAST_30_DAYS = "SETTINGS$YOUR_BUDGET_LAST_30_DAYS",
  SETTINGS$YOUR_BUDGET_YEAR_TO_DATE = "SETTINGS$YOUR_BUDGET_YEAR_TO_DATE",
  SETTINGS$YOUR_BUDGET_ALLOCATION = "SETTINGS$YOUR_BUDGET_ALLOCATION",
  SETTINGS$YOUR_BUDGET_SET_BY_ADMIN_ON = "SETTINGS$YOUR_BUDGET_SET_BY_ADMIN_ON",
  SETTINGS$YOUR_BUDGET_ORG_DEFAULT = "SETTINGS$YOUR_BUDGET_ORG_DEFAULT",
  SETTINGS$YOUR_BUDGET_NO_LIMIT = "SETTINGS$YOUR_BUDGET_NO_LIMIT",
  SETTINGS$YOUR_BUDGET_NO_LIMIT_SET = "SETTINGS$YOUR_BUDGET_NO_LIMIT_SET",
  SETTINGS$YOUR_BUDGET_EXEMPT = "SETTINGS$YOUR_BUDGET_EXEMPT",
  SETTINGS$YOUR_BUDGET_SPENT = "SETTINGS$YOUR_BUDGET_SPENT",
  SETTINGS$YOUR_BUDGET_PER_WEEK = "SETTINGS$YOUR_BUDGET_PER_WEEK",
  SETTINGS$YOUR_BUDGET_SPEND_UNAVAILABLE = "SETTINGS$YOUR_BUDGET_SPEND_UNAVAILABLE",
  SETTINGS$YOUR_BUDGET_SPEND_AS_OF = "SETTINGS$YOUR_BUDGET_SPEND_AS_OF",
  SETTINGS$YOUR_BUDGET_REMAINING = "SETTINGS$YOUR_BUDGET_REMAINING",
  SETTINGS$YOUR_BUDGET_DAYS_AT_RATE = "SETTINGS$YOUR_BUDGET_DAYS_AT_RATE",
  SETTINGS$YOUR_BUDGET_ENOUGH_FOR_CYCLE = "SETTINGS$YOUR_BUDGET_ENOUGH_FOR_CYCLE",
  SETTINGS$YOUR_BUDGET_STATUS_ON_TRACK = "SETTINGS$YOUR_BUDGET_STATUS_ON_TRACK",
  SETTINGS$YOUR_BUDGET_STATUS_OVER_80 = "SETTINGS$YOUR_BUDGET_STATUS_OVER_80",
  SETTINGS$YOUR_BUDGET_STATUS_OVER_90 = "SETTINGS$YOUR_BUDGET_STATUS_OVER_90",
  SETTINGS$YOUR_BUDGET_STATUS_OVER_CAP = "SETTINGS$YOUR_BUDGET_STATUS_OVER_CAP",
  SETTINGS$YOUR_BUDGET_RESETS_ON = "SETTINGS$YOUR_BUDGET_RESETS_ON",
  SETTINGS$YOUR_BUDGET_DAILY_SPENDING = "SETTINGS$YOUR_BUDGET_DAILY_SPENDING",
  SETTINGS$YOUR_BUDGET_TREND_LESS = "SETTINGS$YOUR_BUDGET_TREND_LESS",
  SETTINGS$YOUR_BUDGET_TREND_MORE = "SETTINGS$YOUR_BUDGET_TREND_MORE",
  SETTINGS$YOUR_BUDGET_USAGE_BY_MODEL = "SETTINGS$YOUR_BUDGET_USAGE_BY_MODEL",
  SETTINGS$YOUR_BUDGET_RECENT_USAGE = "SETTINGS$YOUR_BUDGET_RECENT_USAGE",
  SETTINGS$YOUR_BUDGET_UNTITLED = "SETTINGS$YOUR_BUDGET_UNTITLED",
  SETTINGS$YOUR_BUDGET_NO_USAGE = "SETTINGS$YOUR_BUDGET_NO_USAGE",
  SETTINGS$YOUR_BUDGET_ESTIMATE_NOTE = "SETTINGS$YOUR_BUDGET_ESTIMATE_NOTE",
  SETTINGS$YOUR_BUDGET_NOT_ENABLED = "SETTINGS$YOUR_BUDGET_NOT_ENABLED",
  SETTINGS$YOUR_BUDGET_LOAD_ERROR = "SETTINGS$YOUR_BUDGET_LOAD_ERROR",
  SETTINGS$BUDGETS_DEFAULT_FOR_USERS = "SETTINGS$BUDGETS_DEFAULT_FOR_USERS",
  SETTINGS$BUDGETS_DEFAULT_FOR_USERS_DESCRIPTION = "SETTINGS$BUDGETS_DEFAULT_FOR_USERS_DESCRIPTION",
  SETTINGS$BUDGETS_DEFAULT_PREVIEW = "SETTINGS$BUDGETS_DEFAULT_PREVIEW",
  SETTINGS$BUDGETS_TEAM_CAP_HELPER_WITH_PRIOR_SPEND = "SETTINGS$BUDGETS_TEAM_CAP_HELPER_WITH_PRIOR_SPEND",
  SETTINGS$BUDGETS_TEAM_CAP_HELPER = "SETTINGS$BUDGETS_TEAM_CAP_HELPER",
  SETTINGS$BUDGETS_NEXT_RESET = "SETTINGS$BUDGETS_NEXT_RESET",
  SETTINGS$BUDGETS_RESET_DAY_CHANGE_HELPER = "SETTINGS$BUDGETS_RESET_DAY_CHANGE_HELPER",
}
