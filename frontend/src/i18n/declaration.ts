...
export enum I18nKey {
  ...
  FREE_TRIAL$BAR_LABEL = "FREE_TRIAL$BAR_LABEL",
  FREE_TRIAL$DAYS_LEFT = "FREE_TRIAL$DAYS_LEFT",
  FREE_TRIAL$EXPIRED_TITLE = "FREE_TRIAL$EXPIRED_TITLE",
  FREE_TRIAL$EXPIRED_DESCRIPTION = "FREE_TRIAL$EXPIRED_DESCRIPTION",
  FREE_TRIAL$ENTER_LICENSE_KEY = "FREE_TRIAL$ENTER_LICENSE_KEY",
  FREE_TRIAL$LICENSE_KEY_LABEL = "FREE_TRIAL$LICENSE_KEY_LABEL",
  FREE_TRIAL$LICENSE_KEY_PLACEHOLDER = "FREE_TRIAL$LICENSE_KEY_PLACEHOLDER",
  FREE_TRIAL$APPLY_LICENSE_KEY = "FREE_TRIAL$APPLY_LICENSE_KEY",
  FREE_TRIAL$CHOOSE_PLAN = "FREE_TRIAL$CHOOSE_PLAN",
  FREE_TRIAL$CONTACT_SALES = "FREE_TRIAL$CONTACT_SALES",
}
