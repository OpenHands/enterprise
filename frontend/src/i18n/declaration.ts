...
export enum I18nKey {
  ...
  SETTINGS$LLM_API_KEY_DISABLED_MESSAGE = "SETTINGS$LLM_API_KEY_DISABLED_MESSAGE",
  ...
  SETTINGS$GPG_KEY_BUTTON = "SETTINGS$GPG_KEY_BUTTON",
  SETTINGS$GPG_KEY = "SETTINGS$GPG_KEY",
  SETTINGS$GPG_KEY_MODAL_DESCRIPTION = "SETTINGS$GPG_KEY_MODAL_DESCRIPTION",
  SETTINGS$GPG_KEY_EXPORT_STEP_1 = "SETTINGS$GPG_KEY_EXPORT_STEP_1",
  SETTINGS$GPG_KEY_LIST_COMMAND = "SETTINGS$GPG_KEY_LIST_COMMAND",
  SETTINGS$GPG_KEY_EXPORT_STEP_2 = "SETTINGS$GPG_KEY_EXPORT_STEP_2",
  SETTINGS$GPG_KEY_EXPORT_COMMAND = "SETTINGS$GPG_KEY_EXPORT_COMMAND",
  SETTINGS$GPG_KEY_VALUE_LABEL = "SETTINGS$GPG_KEY_VALUE_LABEL",
  SETTINGS$GPG_KEY_VALUE_PLACEHOLDER = "SETTINGS$GPG_KEY_VALUE_PLACEHOLDER",
  SETTINGS$GPG_KEY_DESCRIPTION = "SETTINGS$GPG_KEY_DESCRIPTION",
  SETTINGS$GPG_KEY_EXISTS = "SETTINGS$GPG_KEY_EXISTS",
  SETTINGS$GPG_KEY_SAVE = "SETTINGS$GPG_KEY_SAVE",
  SETTINGS$GPG_KEY_SAVING = "SETTINGS$GPG_KEY_SAVING",
  SETTINGS$GPG_KEY_SAVED = "SETTINGS$GPG_KEY_SAVED",
  ...
  PROJECT_MANAGEMENT$JIRA_MEMBER_CONFIGURED_PROMPT = "PROJECT_MANAGEMENT$JIRA_MEMBER_CONFIGURED_PROMPT",
  PROJECT_MANAGEMENT$JIRA_MEMBER_NOT_CONFIGURED_PROMPT = "PROJECT_MANAGEMENT$JIRA_MEMBER_NOT_CONFIGURED_PROMPT",
  PROJECT_MANAGEMENT$JIRA_MANUAL_WEBHOOK_INSTRUCTIONS = "PROJECT_MANAGEMENT$JIRA_MANUAL_WEBHOOK_INSTRUCTIONS",
  PROJECT_MANAGEMENT$JIRA_MEMBER_ASK_ADMIN = "PROJECT_MANAGEMENT$JIRA_MEMBER_ASK_ADMIN",
  ...
  SETTINGS$NAV_QUOTA = "SETTINGS$NAV_QUOTA",
  SETTINGS$QUOTA_DAILY_LIMIT = "SETTINGS$QUOTA_DAILY_LIMIT",
  SETTINGS$QUOTA_USED_TODAY = "SETTINGS$QUOTA_USED_TODAY",
  SETTINGS$QUOTA_REMAINING = "SETTINGS$QUOTA_REMAINING",
  SETTINGS$QUOTA_UNLIMITED = "SETTINGS$QUOTA_UNLIMITED",
  SETTINGS$QUOTA_RESETS_IN = "SETTINGS$QUOTA_RESETS_IN",
  SETTINGS$QUOTA_SALES_ONLY = "SETTINGS$QUOTA_SALES_ONLY",
  SETTINGS$QUOTA_REQUEST_TITLE = "SETTINGS$QUOTA_REQUEST_TITLE",
  SETTINGS$QUOTA_REQUEST_DESCRIPTION = "SETTINGS$QUOTA_REQUEST_DESCRIPTION",
  SETTINGS$QUOTA_WORK_EMAIL = "SETTINGS$QUOTA_WORK_EMAIL",
  SETTINGS$QUOTA_REQUESTED_LIMIT = "SETTINGS$QUOTA_REQUESTED_LIMIT",
  SETTINGS$QUOTA_MAX_ALLOWED = "SETTINGS$QUOTA_MAX_ALLOWED",
  SETTINGS$QUOTA_REASON = "SETTINGS$QUOTA_REASON",
  SETTINGS$QUOTA_OPTIONAL = "SETTINGS$QUOTA_OPTIONAL",
  SETTINGS$QUOTA_SUBMIT = "SETTINGS$QUOTA_SUBMIT",
  SETTINGS$QUOTA_SUBMITTING = "SETTINGS$QUOTA_SUBMITTING",
  SETTINGS$QUOTA_REQUEST_SENT = "SETTINGS$QUOTA_REQUEST_SENT",
  SETTINGS$QUOTA_REQUEST_FAILED = "SETTINGS$QUOTA_REQUEST_FAILED",
  SETTINGS$QUOTA_REQUEST_PENDING = "SETTINGS$QUOTA_REQUEST_PENDING",
  SETTINGS$QUOTA_REQUEST_APPROVED = "SETTINGS$QUOTA_REQUEST_APPROVED",
  BUTTON$CONNECT = "BUTTON$CONNECT",
  STATUS$NOT_CONNECTED = "STATUS$NOT_CONNECTED",
  SETTINGS$BITBUCKET = "SETTINGS$BITBUCKET",
  GIT_PROVIDER$DISCONNECT_CONFIRMATION = "GIT_PROVIDER$DISCONNECT_CONFIRMATION",
  GIT_PROVIDER$LINK_FAILED = "GIT_PROVIDER$LINK_FAILED",
  NATIVE_AUTH$EMAIL = "NATIVE_AUTH$EMAIL",
  NATIVE_AUTH$PASSWORD = "NATIVE_AUTH$PASSWORD",
  NATIVE_AUTH$SIGN_IN = "NATIVE_AUTH$SIGN_IN",
  NATIVE_AUTH$CONFIRM_IDENTITY = "NATIVE_AUTH$CONFIRM_IDENTITY",
  NATIVE_AUTH$CONTACT_ADMIN = "NATIVE_AUTH$CONTACT_ADMIN",
  NATIVE_AUTH$REQUEST_FAILED = "NATIVE_AUTH$REQUEST_FAILED",
  NATIVE_AUTH$NEW_PASSWORD = "NATIVE_AUTH$NEW_PASSWORD",
  NATIVE_AUTH$CONFIRM_PASSWORD = "NATIVE_AUTH$CONFIRM_PASSWORD",
  NATIVE_AUTH$PASSWORD_HELP = "NATIVE_AUTH$PASSWORD_HELP",
  NATIVE_AUTH$PASSWORD_MISMATCH = "NATIVE_AUTH$PASSWORD_MISMATCH",
  NATIVE_AUTH$SET_UP_ACCOUNT = "NATIVE_AUTH$SET_UP_ACCOUNT",
  NATIVE_AUTH$LINK_UNAVAILABLE = "NATIVE_AUTH$LINK_UNAVAILABLE",
  NATIVE_AUTH$INVITED_ORG = "NATIVE_AUTH$INVITED_ORG",
  NATIVE_AUTH$EXISTING_ACCOUNT = "NATIVE_AUTH$EXISTING_ACCOUNT",
  NATIVE_AUTH$BACK_TO_LOGIN = "NATIVE_AUTH$BACK_TO_LOGIN",
  NATIVE_AUTH$RESET_PASSWORD = "NATIVE_AUTH$RESET_PASSWORD",
  NATIVE_AUTH$PASSWORD_RESET_COMPLETE = "NATIVE_AUTH$PASSWORD_RESET_COMPLETE",
  NATIVE_AUTH$CHANGE_PASSWORD = "NATIVE_AUTH$CHANGE_PASSWORD",
  NATIVE_AUTH$CURRENT_PASSWORD = "NATIVE_AUTH$CURRENT_PASSWORD",
  NATIVE_AUTH$PASSWORD_CHANGED = "NATIVE_AUTH$PASSWORD_CHANGED",
  NATIVE_AUTH$REAUTH_REQUIRED = "NATIVE_AUTH$REAUTH_REQUIRED",
  NATIVE_AUTH$USERS = "NATIVE_AUTH$USERS",
  NATIVE_AUTH$USERS_HELP = "NATIVE_AUTH$USERS_HELP",
  NATIVE_AUTH$INVITE_USER = "NATIVE_AUTH$INVITE_USER",
  NATIVE_AUTH$OPTIONAL_ORG = "NATIVE_AUTH$OPTIONAL_ORG",
  NATIVE_AUTH$PERSONAL_WORKSPACE_ONLY = "NATIVE_AUTH$PERSONAL_WORKSPACE_ONLY",
  NATIVE_AUTH$ORG_ROLE = "NATIVE_AUTH$ORG_ROLE",
  NATIVE_AUTH$SELECT_ROLE = "NATIVE_AUTH$SELECT_ROLE",
  NATIVE_AUTH$CREATE_SETUP_LINK = "NATIVE_AUTH$CREATE_SETUP_LINK",
  NATIVE_AUTH$ACCOUNTS = "NATIVE_AUTH$ACCOUNTS",
  NATIVE_AUTH$NO_ACCOUNTS = "NATIVE_AUTH$NO_ACCOUNTS",
  NATIVE_AUTH$NO_INVITATIONS = "NATIVE_AUTH$NO_INVITATIONS",
  NATIVE_AUTH$INVITATIONS = "NATIVE_AUTH$INVITATIONS",
  NATIVE_AUTH$ACTIVE = "NATIVE_AUTH$ACTIVE",
  NATIVE_AUTH$DISABLED = "NATIVE_AUTH$DISABLED",
  NATIVE_AUTH$DELETED = "NATIVE_AUTH$DELETED",
  NATIVE_AUTH$PROFILE_ABSENT = "NATIVE_AUTH$PROFILE_ABSENT",
  NATIVE_AUTH$ENABLE = "NATIVE_AUTH$ENABLE",
  NATIVE_AUTH$DISABLE = "NATIVE_AUTH$DISABLE",
  NATIVE_AUTH$DELETE = "NATIVE_AUTH$DELETE",
  NATIVE_AUTH$GRANT_ADMIN = "NATIVE_AUTH$GRANT_ADMIN",
  NATIVE_AUTH$REVOKE_ADMIN = "NATIVE_AUTH$REVOKE_ADMIN",
  NATIVE_AUTH$CREATE_RESET_LINK = "NATIVE_AUTH$CREATE_RESET_LINK",
  NATIVE_AUTH$PENDING_SETUP = "NATIVE_AUTH$PENDING_SETUP",
  NATIVE_AUTH$ACCEPTED = "NATIVE_AUTH$ACCEPTED",
  NATIVE_AUTH$REVOKED = "NATIVE_AUTH$REVOKED",
  NATIVE_AUTH$EXPIRED = "NATIVE_AUTH$EXPIRED",
  NATIVE_AUTH$PENDING = "NATIVE_AUTH$PENDING",
  NATIVE_AUTH$REISSUE = "NATIVE_AUTH$REISSUE",
  NATIVE_AUTH$REVOKE = "NATIVE_AUTH$REVOKE",
  NATIVE_AUTH$DELETE_HELP = "NATIVE_AUTH$DELETE_HELP",
  NATIVE_AUTH$ADMIN_ACTION_HELP = "NATIVE_AUTH$ADMIN_ACTION_HELP",
  NATIVE_AUTH$CONFIRM = "NATIVE_AUTH$CONFIRM",
  NATIVE_AUTH$CANCEL = "NATIVE_AUTH$CANCEL",
  NATIVE_AUTH$SHARE_LINK = "NATIVE_AUTH$SHARE_LINK",
  NATIVE_AUTH$COPY_ONCE_HELP = "NATIVE_AUTH$COPY_ONCE_HELP",
  NATIVE_AUTH$EXPIRES = "NATIVE_AUTH$EXPIRES",
  NATIVE_AUTH$PRIVATE_LINK = "NATIVE_AUTH$PRIVATE_LINK",
  NATIVE_AUTH$COPY_MANUALLY = "NATIVE_AUTH$COPY_MANUALLY",
  NATIVE_AUTH$COPY_LINK = "NATIVE_AUTH$COPY_LINK",
  NATIVE_AUTH$COPIED = "NATIVE_AUTH$COPIED",
  NATIVE_AUTH$CLOSE = "NATIVE_AUTH$CLOSE",
  NATIVE_AUTH$PROFILE_UNAVAILABLE = "NATIVE_AUTH$PROFILE_UNAVAILABLE",
  NATIVE_AUTH$NO_LOGIN_METHODS = "NATIVE_AUTH$NO_LOGIN_METHODS",
  NATIVE_AUTH$SIGN_IN_METHODS = "NATIVE_AUTH$SIGN_IN_METHODS",
  NATIVE_AUTH$EMAIL_PASSWORD_METHOD = "NATIVE_AUTH$EMAIL_PASSWORD_METHOD",
  NATIVE_AUTH$SIGN_IN_EMAIL = "NATIVE_AUTH$SIGN_IN_EMAIL",
  NATIVE_AUTH$SIGN_IN_SSO = "NATIVE_AUTH$SIGN_IN_SSO",
  NATIVE_AUTH$OTHER_SIGN_IN_METHOD = "NATIVE_AUTH$OTHER_SIGN_IN_METHOD",
  NATIVE_AUTH$SSO_FAILED = "NATIVE_AUTH$SSO_FAILED",
  NATIVE_AUTH$SSO_ACCOUNT_LINK_REQUIRED = "NATIVE_AUTH$SSO_ACCOUNT_LINK_REQUIRED",
  NATIVE_AUTH$SSO_INVITATION_REQUIRED = "NATIVE_AUTH$SSO_INVITATION_REQUIRED",
  NATIVE_AUTH$SSO_EMAIL_MISMATCH = "NATIVE_AUTH$SSO_EMAIL_MISMATCH",
  NATIVE_AUTH$SSO_UNAVAILABLE = "NATIVE_AUTH$SSO_UNAVAILABLE",
  NATIVE_AUTH$SSO_RECENT_AUTH_REQUIRED = "NATIVE_AUTH$SSO_RECENT_AUTH_REQUIRED",
  NATIVE_AUTH$SSO_TEMPORARILY_UNAVAILABLE = "NATIVE_AUTH$SSO_TEMPORARILY_UNAVAILABLE",
  NATIVE_AUTH$SSO_COMPLETING = "NATIVE_AUTH$SSO_COMPLETING",
  NATIVE_AUTH$SSO_METHOD = "NATIVE_AUTH$SSO_METHOD",
  NATIVE_AUTH$SSO_PASSWORD_HELP = "NATIVE_AUTH$SSO_PASSWORD_HELP",
  NATIVE_AUTH$LINK_SSO = "NATIVE_AUTH$LINK_SSO",
  NATIVE_AUTH$LINK_SSO_HELP = "NATIVE_AUTH$LINK_SSO_HELP",
  NATIVE_AUTH$SSO_REAUTH_RETRY = "NATIVE_AUTH$SSO_REAUTH_RETRY",
  HOME$CONNECT_NATIVE_PROVIDER_MESSAGE = "HOME$CONNECT_NATIVE_PROVIDER_MESSAGE",
  NATIVE_GIT$OPTIONAL_HELP = "NATIVE_GIT$OPTIONAL_HELP",
  NATIVE_GIT$CONNECTED = "NATIVE_GIT$CONNECTED",
  NATIVE_GIT$NOT_CONNECTED = "NATIVE_GIT$NOT_CONNECTED",
  NATIVE_GIT$RECONNECT_REQUIRED = "NATIVE_GIT$RECONNECT_REQUIRED",
  NATIVE_GIT$CANCELLED = "NATIVE_GIT$CANCELLED",
  NATIVE_GIT$OAUTH_ERROR = "NATIVE_GIT$OAUTH_ERROR",
  NATIVE_GIT$UNAVAILABLE = "NATIVE_GIT$UNAVAILABLE",
  NATIVE_GIT$TRY_AGAIN = "NATIVE_GIT$TRY_AGAIN",
  NATIVE_GIT$NO_PROVIDERS = "NATIVE_GIT$NO_PROVIDERS",
  NATIVE_GIT$HOST = "NATIVE_GIT$HOST",
  NATIVE_GIT$PAT = "NATIVE_GIT$PAT",
  NATIVE_GIT$TOKEN_HELP = "NATIVE_GIT$TOKEN_HELP",
  NATIVE_GIT$CONNECT = "NATIVE_GIT$CONNECT",
  NATIVE_GIT$RECONNECT = "NATIVE_GIT$RECONNECT",
  NATIVE_GIT$SAVED = "NATIVE_GIT$SAVED",
  NATIVE_GIT$CONNECT_OAUTH = "NATIVE_GIT$CONNECT_OAUTH",
  NATIVE_GIT$DISCONNECT_HELP = "NATIVE_GIT$DISCONNECT_HELP",
  BUDGETS$LITELLM_REQUIRED = "BUDGETS$LITELLM_REQUIRED",
  SETTINGS$MANAGED_MODEL_UNAVAILABLE = "SETTINGS$MANAGED_MODEL_UNAVAILABLE",
  SETTINGS$PROFILE_UNAVAILABLE_BADGE = "SETTINGS$PROFILE_UNAVAILABLE_BADGE",
  SANDBOX$TEMPORARILY_UNAVAILABLE = "SANDBOX$TEMPORARILY_UNAVAILABLE",
  NATIVE_GIT$BITBUCKET_EMAIL = "NATIVE_GIT$BITBUCKET_EMAIL",
  NATIVE_GIT$API_TOKEN = "NATIVE_GIT$API_TOKEN",
}
