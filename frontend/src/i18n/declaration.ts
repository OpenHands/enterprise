...
export enum I18nKey {
  ...
  AUTH$ACCEPTED = "AUTH$ACCEPTED",
  AUTH$ACCOUNTS = "AUTH$ACCOUNTS",
  AUTH$ACTIVE = "AUTH$ACTIVE",
  AUTH$ADMIN_ACTION_HELP = "AUTH$ADMIN_ACTION_HELP",
  AUTH$BACK_TO_LOGIN = "AUTH$BACK_TO_LOGIN",
  AUTH$CANCEL = "AUTH$CANCEL",
  AUTH$CHANGE_PASSWORD = "AUTH$CHANGE_PASSWORD",
  AUTH$CLOSE = "AUTH$CLOSE",
  AUTH$CONFIRM = "AUTH$CONFIRM",
  AUTH$CONFIRM_IDENTITY = "AUTH$CONFIRM_IDENTITY",
  AUTH$CONFIRM_PASSWORD = "AUTH$CONFIRM_PASSWORD",
  AUTH$CONTACT_ADMIN = "AUTH$CONTACT_ADMIN",
  AUTH$COPIED = "AUTH$COPIED",
  AUTH$COPY_LINK = "AUTH$COPY_LINK",
  AUTH$COPY_MANUALLY = "AUTH$COPY_MANUALLY",
  AUTH$COPY_ONCE_HELP = "AUTH$COPY_ONCE_HELP",
  AUTH$CREATE_RESET_LINK = "AUTH$CREATE_RESET_LINK",
  AUTH$CREATE_SETUP_LINK = "AUTH$CREATE_SETUP_LINK",
  AUTH$CURRENT_PASSWORD = "AUTH$CURRENT_PASSWORD",
  AUTH$DELETE = "AUTH$DELETE",
  AUTH$DELETED = "AUTH$DELETED",
  AUTH$DELETE_HELP = "AUTH$DELETE_HELP",
  AUTH$DISABLE = "AUTH$DISABLE",
  AUTH$DISABLED = "AUTH$DISABLED",
  AUTH$EMAIL = "AUTH$EMAIL",
  AUTH$EMAIL_PASSWORD_METHOD = "AUTH$EMAIL_PASSWORD_METHOD",
  AUTH$ENABLE = "AUTH$ENABLE",
  AUTH$EXISTING_ACCOUNT = "AUTH$EXISTING_ACCOUNT",
  AUTH$EXPIRED = "AUTH$EXPIRED",
  AUTH$EXPIRES = "AUTH$EXPIRES",
  AUTH$GRANT_ADMIN = "AUTH$GRANT_ADMIN",
  AUTH$INVITATIONS = "AUTH$INVITATIONS",
  AUTH$INVITED_ORG = "AUTH$INVITED_ORG",
  AUTH$INVITE_USER = "AUTH$INVITE_USER",
  AUTH$LINK_UNAVAILABLE = "AUTH$LINK_UNAVAILABLE",
  AUTH$NEW_PASSWORD = "AUTH$NEW_PASSWORD",
  AUTH$NO_ACCOUNTS = "AUTH$NO_ACCOUNTS",
  AUTH$NO_INVITATIONS = "AUTH$NO_INVITATIONS",
  AUTH$NO_LOGIN_METHODS = "AUTH$NO_LOGIN_METHODS",
  AUTH$OPTIONAL_ORG = "AUTH$OPTIONAL_ORG",
  AUTH$ORG_ROLE = "AUTH$ORG_ROLE",
  AUTH$PASSWORD = "AUTH$PASSWORD",
  AUTH$PASSWORD_CHANGED = "AUTH$PASSWORD_CHANGED",
  AUTH$PASSWORD_HELP = "AUTH$PASSWORD_HELP",
  AUTH$PASSWORD_MISMATCH = "AUTH$PASSWORD_MISMATCH",
  AUTH$PASSWORD_RESET_COMPLETE = "AUTH$PASSWORD_RESET_COMPLETE",
  AUTH$PENDING = "AUTH$PENDING",
  AUTH$PENDING_SETUP = "AUTH$PENDING_SETUP",
  AUTH$PERSONAL_WORKSPACE_ONLY = "AUTH$PERSONAL_WORKSPACE_ONLY",
  AUTH$PRIVATE_LINK = "AUTH$PRIVATE_LINK",
  AUTH$PROFILE_ABSENT = "AUTH$PROFILE_ABSENT",
  AUTH$PROFILE_UNAVAILABLE = "AUTH$PROFILE_UNAVAILABLE",
  AUTH$REAUTH_REQUIRED = "AUTH$REAUTH_REQUIRED",
  AUTH$REISSUE = "AUTH$REISSUE",
  AUTH$REQUEST_FAILED = "AUTH$REQUEST_FAILED",
  AUTH$RESET_PASSWORD = "AUTH$RESET_PASSWORD",
  AUTH$REVOKE = "AUTH$REVOKE",
  AUTH$REVOKED = "AUTH$REVOKED",
  AUTH$REVOKE_ADMIN = "AUTH$REVOKE_ADMIN",
  AUTH$SELECT_ROLE = "AUTH$SELECT_ROLE",
  AUTH$SET_UP_ACCOUNT = "AUTH$SET_UP_ACCOUNT",
  AUTH$SHARE_LINK = "AUTH$SHARE_LINK",
  AUTH$SIGN_IN = "AUTH$SIGN_IN",
  AUTH$SIGN_IN_METHODS = "AUTH$SIGN_IN_METHODS",
  AUTH$USERS = "AUTH$USERS",
  AUTH$USERS_HELP = "AUTH$USERS_HELP",
}
