...
export enum I18nKey {
  BUDGET_CONTROL$MANAGED = "BUDGET_CONTROL$MANAGED",
  BUDGET_CONTROL$EXTERNAL = "BUDGET_CONTROL$EXTERNAL",
  BUDGET_CONTROL$NEEDS_ADOPTION = "BUDGET_CONTROL$NEEDS_ADOPTION",
  BUDGET_CONTROL$EXTERNAL_EXPLANATION = "BUDGET_CONTROL$EXTERNAL_EXPLANATION",
  BUDGET_CONTROL$PREVIEW = "BUDGET_CONTROL$PREVIEW",
  BUDGET_CONTROL$NATIVE_POLICY = "BUDGET_CONTROL$NATIVE_POLICY",
  BUDGET_CONTROL$INDEPENDENT_LIMITS = "BUDGET_CONTROL$INDEPENDENT_LIMITS",
  BUDGET_CONTROL$UNCERTAIN_REQUEST = "BUDGET_CONTROL$UNCERTAIN_REQUEST",
  BUDGET_CONTROL$REQUEST_ERROR = "BUDGET_CONTROL$REQUEST_ERROR",
  BUDGET_CONTROL$RECOVERY_UNAVAILABLE = "BUDGET_CONTROL$RECOVERY_UNAVAILABLE",
  BUDGET_CONTROL$HANDOFF = "BUDGET_CONTROL$HANDOFF",
  BUDGET_CONTROL$HANDOFF_WARNING = "BUDGET_CONTROL$HANDOFF_WARNING",
  BUDGET_CONTROL$INHERIT = "BUDGET_CONTROL$INHERIT",
  BUDGET_CONTROL$NO_MEMBER_LIMIT = "BUDGET_CONTROL$NO_MEMBER_LIMIT",
  BUDGET_CONTROL$AVAILABLE_NOW = "BUDGET_CONTROL$AVAILABLE_NOW",
  BUDGET_CONTROL$CYCLE_TOTAL = "BUDGET_CONTROL$CYCLE_TOTAL",
  BUDGET_CONTROL$FUTURE_ALLOWANCE = "BUDGET_CONTROL$FUTURE_ALLOWANCE",
  BUDGET_CONTROL$ENFORCE = "BUDGET_CONTROL$ENFORCE",
  BUDGET_CONTROL$ORGANIZATION = "BUDGET_CONTROL$ORGANIZATION",
  BUDGET_CONTROL$DEFAULT_MEMBER = "BUDGET_CONTROL$DEFAULT_MEMBER",
  BUDGET_CONTROL$RESET_DAY = "BUDGET_CONTROL$RESET_DAY",
  BUDGET_CONTROL$REPLACE_RESETS = "BUDGET_CONTROL$REPLACE_RESETS",
  BUDGET_CONTROL$MEMBER_OVERRIDES = "BUDGET_CONTROL$MEMBER_OVERRIDES",
  BUDGET_CONTROL$INVALID_ALLOWANCE = "BUDGET_CONTROL$INVALID_ALLOWANCE",
  BUDGET_CONTROL$PENDING = "BUDGET_CONTROL$PENDING",
  BUDGET_CONTROL$APPLIED = "BUDGET_CONTROL$APPLIED",
  BUDGET_CONTROL$ABANDONED = "BUDGET_CONTROL$ABANDONED",
  BUDGET_CONTROL$STATUS_UNAVAILABLE = "BUDGET_CONTROL$STATUS_UNAVAILABLE",
  BUDGET_CONTROL$RETRY_FAILED = "BUDGET_CONTROL$RETRY_FAILED",
  BUDGET_CONTROL$OPERATION = "BUDGET_CONTROL$OPERATION",
  ...
  ORG$REMOVE_MEMBER_REVOCATION_PENDING = "ORG$REMOVE_MEMBER_REVOCATION_PENDING",
