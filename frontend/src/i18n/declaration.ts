...
export enum I18nKey {
  ...
  AUTH$PASSWORD_SIGN_IN = "AUTH$PASSWORD_SIGN_IN",
  AUTH$PASSWORD = "AUTH$PASSWORD",
  AUTH$FORGOT_PASSWORD = "AUTH$FORGOT_PASSWORD",
  AUTH$ENROLL_INVITATION = "AUTH$ENROLL_INVITATION",
  AUTH$ENROLLMENT_POLICY = "AUTH$ENROLLMENT_POLICY",
  AUTH$ACTION_FAILED = "AUTH$ACTION_FAILED",
  AUTH$TRY_LATER = "AUTH$TRY_LATER",
  AUTH$INVALID_CREDENTIALS = "AUTH$INVALID_CREDENTIALS",
  AUTH$INVALID_ACTION_LINK = "AUTH$INVALID_ACTION_LINK",
  AUTH$PASSWORD_REQUIREMENTS = "AUTH$PASSWORD_REQUIREMENTS",
  ...
  AUTH$CHANGE_PASSWORD_DESCRIPTION = "AUTH$CHANGE_PASSWORD_DESCRIPTION",
  AUTH$VERIFY_EMAIL_DESCRIPTION = "AUTH$VERIFY_EMAIL_DESCRIPTION",
  AUTH$REQUEST_VERIFICATION_DESCRIPTION = "AUTH$REQUEST_VERIFICATION_DESCRIPTION",
  AUTH$USE_LOGIN_PROVIDER = "AUTH$USE_LOGIN_PROVIDER",
  AUTH$EMAIL_UNAVAILABLE = "AUTH$EMAIL_UNAVAILABLE",
  AUTH$CHECK_EMAIL = "AUTH$CHECK_EMAIL",
  AUTH$SEND_EMAIL = "AUTH$SEND_EMAIL",
  AUTH$BACK_TO_LOGIN = "AUTH$BACK_TO_LOGIN",
  AUTH$EMAIL_NOT_VERIFIED = "AUTH$EMAIL_NOT_VERIFIED",
  AUTH$NEW_LOGIN_EMAIL = "AUTH$NEW_LOGIN_EMAIL",
  AUTH$EMAIL_CHANGE_DESCRIPTION = "AUTH$EMAIL_CHANGE_DESCRIPTION",
  AUTH$CREATE_ACCOUNT = "AUTH$CREATE_ACCOUNT",
  AUTH$CREATE_ACCOUNT_DESCRIPTION = "AUTH$CREATE_ACCOUNT_DESCRIPTION",
  AUTH$INITIAL_PASSWORD = "AUTH$INITIAL_PASSWORD",
  AUTH$ACCOUNT_ACCESS_DENIED = "AUTH$ACCOUNT_ACCESS_DENIED",
  AUTH$ACCOUNT_CREATED = "AUTH$ACCOUNT_CREATED",
  AUTH$MANAGE_ACCOUNTS = "AUTH$MANAGE_ACCOUNTS",
}
