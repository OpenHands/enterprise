...
export enum I18nKey {
  ...
  SUPER_ADMIN$NAV_DASHBOARD = "SUPER_ADMIN$NAV_DASHBOARD",
  SUPER_ADMIN$TITLE = "SUPER_ADMIN$TITLE",
  SUPER_ADMIN$SUBTITLE = "SUPER_ADMIN$SUBTITLE",
  SUPER_ADMIN$NO_ORGS = "SUPER_ADMIN$NO_ORGS",
  SUPER_ADMIN$LOAD_ORGS_ERROR = "SUPER_ADMIN$LOAD_ORGS_ERROR",
  SUPER_ADMIN$INVITE_TO_ORG_TITLE = "SUPER_ADMIN$INVITE_TO_ORG_TITLE",
