...
export const TOAST_OPTIONS: DefaultToastOptions = {
  ...
  success: {
    iconTheme: {
      primary: "var(--oh-status-success)",
      secondary: "var(--oh-color-tertiary)",
    },
  },
  loading: {
    iconTheme: {
      primary: "var(--oh-muted)",
      secondary: "var(--oh-color-tertiary)",
    },
  },
};

export const displayLoadingToast = (
  message: string,
  options?: Pick<ToastOptions, "id">,
) => toast.loading(message, { ...TOAST_OPTIONS, ...options });
