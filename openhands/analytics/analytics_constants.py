...
CONVERSATION_PROVISIONING_FAILED = 'conversation provisioning failed'
FIRST_AGENT_RESPONSE_COMPLETED = 'first agent response completed'
FIRST_AGENT_RESPONSE_FAILED = 'first agent response failed'
