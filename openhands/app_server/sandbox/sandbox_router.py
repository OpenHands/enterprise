...
@router.post(
    '/{sandbox_id}/resume',
    responses={
        404: {'description': 'Sandbox or runtime not found'},
        409: {'description': 'Runtime exists but cannot be resumed from its state'},
...
async def resume_sandbox(
    ...
    """Resume a resumable sandbox or no-op when it is active.

    No-op responses do not expose or rotate the existing session key.
    """
