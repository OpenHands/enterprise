...
class TestFreeEmailDomains:
    ...
    def test_all_research_pr88_domains_present(self):
        expected = {
            '126.com', '163.com', 'aol.com', 'aliyun.com', 'atomicmail.io',
            'foxmail.com', 'gmx.com', 'gmail.com', 'googlemail.com',
            'hotmail.com', 'icloud.com', 'live.com', 'live.cn', 'mail.com',
            'outlook.com', 'pm.me', 'proton.me', 'protonmail.com', 'qq.com',
            'sina.cn', 'sina.com', 'sohu.com', 'yahoo.com', 'yandex.com',
            'yandex.ru', 'yeah.net',
        }
