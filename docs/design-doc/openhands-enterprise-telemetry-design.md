...
- [ ] `migrations/versions/077_create_telemetry_tables.py`
- [ ] `storage/telemetry_metrics.py`
- [ ] `storage/telemetry_config.py`

#### 5.1.2 OpenHands - Model Tests

- [ ] `tests/unit/storage/test_telemetry_metrics.py`
- [ ] `tests/unit/storage/test_telemetry_config.py`
...
- [ ] `server/telemetry/collector_base.py`
- [ ] `server/telemetry/collector_registry.py`
- [ ] `server/telemetry/decorators.py`

#### 5.2.2 OpenHands - Example Collectors

- [ ] `server/telemetry/collectors/__init__.py`
- [ ] `server/telemetry/collectors/system_metrics.py`
- [ ] `server/telemetry/collectors/user_activity.py`

#### 5.2.3 OpenHands - Framework Tests

- [ ] `tests/unit/telemetry/test_collector_base.py`
- [ ] `tests/unit/telemetry/test_collector_registry.py`
- [ ] `tests/unit/telemetry/test_system_metrics.py`
...
- [ ] `server/telemetry/collection_processor.py`
- [ ] `tests/unit/telemetry/test_collection_processor.py`

#### 5.3.2 OpenHands - Upload Processor

- [ ] `server/telemetry/upload_processor.py`
- [ ] `tests/unit/telemetry/test_upload_processor.py`
...
- [ ] `tests/unit/routes/test_license.py`

#### 5.4.2 OpenHands - API Integration

- [ ] Update `saas_server.py` to include license router
...
- [ ] `server/telemetry/collectors/conversation_metrics.py`
- [ ] `server/telemetry/collectors/integration_usage.py`
- [ ] `server/telemetry/collectors/performance_metrics.py`

#### 5.7.2 OpenHands - Monitoring and Testing

- [ ] `server/telemetry/monitoring.py`
- [ ] `tests/e2e/test_telemetry_system.py`
