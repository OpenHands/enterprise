...
async def main() -> None:
    from server.auth.server_wiring import run_authentication_maintenance

    await run_authentication_maintenance()
...
async def run_tasks() -> int:
    from server.auth.server_wiring import verify_authentication_worker
