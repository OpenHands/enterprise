...
Usage:
    ...
    python scripts/seed_conversation_data.py

    # With custom database URL
    DATABASE_URL=postgresql://user:pass@host:5432/db python scripts/seed_conversation_data.py

    # With options
    python scripts/seed_conversation_data.py --org-count 3 --conversations-per-org 50
"""
